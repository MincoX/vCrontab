    ...
    <div class="row">
        <div class="col-9">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header d-flex p-0">
                    ...
                    <ul class="nav nav-pills ml-auto p-2 float-right">
                        <li class="nav-item dropdown show">
                            ...
                            <div class="dropdown-menu" id="addJob-dropdown-menu"
                                 x-placement="bottom-start">
                                <a class="dropdown-item" tabindex="-1" href="#" @click="
                ...
                <!-- jobs -->
                <Pagination :page-index="jobCurrentPage" :total="jobTotalCount"
                            :page-size="jobPageSize" @change="jobPageChange" />
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="card-header">
                                ...
                                <!-- logs -->
                                <Pagination class="float-right" :page-index="logCurrentPage"
                                            :total="logTotalCount" :page-size="logPageSize"
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody class="log-table">
                                    ...
                                    <tr v-for="item in logPageDatas" :key="item.id"
                                        class="text-center">
                                        <td>{{ item.job_name }}</td>
                                        <td>{{ item.command }}</td>
                                        ...
                                        <td>{{ item.end_time }}</td>
                                        <td class="tooltips">
                                            <p class="badge bg-danger hb-gold"
                                               v-if="item.result == '0'">
                                                执行错误
                                            </p>
                                            ...
                                            <span class="direct-chat-text"
                                                  v-if="item.err != ''">{{ "错误输出：" + item.err }}</span>
